...
public class ModelDrivenEngineeringPackageImpl extends EPackageImpl implements ModelDrivenEngineeringPackage {
	...
	public static ModelDrivenEngineeringPackage init() {
		...
		theModelDrivenEngineeringPackage.createPackageContents();

		// Initialize created meta-data
		theModelDrivenEngineeringPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theModelDrivenEngineeringPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ModelDrivenEngineeringPackage.eNS_URI, theModelDrivenEngineeringPackage);
		return theModelDrivenEngineeringPackage;
	}
