...
public class ForgeSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ForgePackage.BACKEND_CONFIG: {
				BackendConfig backendConfig = (BackendConfig)theEObject;
				T result = caseBackendConfig(backendConfig);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ForgePackage.PROJECT: {
				Project project = (Project)theEObject;
				T result = caseProject(project);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ForgePackage.DATABASE: {
				Database database = (Database)theEObject;
				T result = caseDatabase(database);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ForgePackage.TABLE: {
				Table table = (Table)theEObject;
				T result = caseTable(table);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ForgePackage.COLUMN: {
				Column column = (Column)theEObject;
				T result = caseColumn(column);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ForgePackage.RELATION: {
				Relation relation = (Relation)theEObject;
				T result = caseRelation(relation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ForgePackage.API: {
				Api api = (Api)theEObject;
				T result = caseApi(api);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ForgePackage.ROUTE: {
