 ...
 * </p>
 * <ul>
 * <li>{@link Forge.impl.ProjectImpl#getGroupId <em>Group
 * Id</em>}</li>
 * <li>{@link Forge.impl.ProjectImpl#getJavaVersion <em>Java
 * Version</em>}</li>
 * <li>{@link Forge.impl.ProjectImpl#getSpringBootVersion
 * <em>Spring Boot Version</em>}</li>
 * <li>{@link Forge.impl.ProjectImpl#getName
 * <em>Name</em>}</li>
 * <li>{@link Forge.impl.ProjectImpl#getVersion
 * <em>Version</em>}</li>
 * <li>{@link Forge.impl.ProjectImpl#getLanguage
 * <em>Language</em>}</li>
 * <li>{@link Forge.impl.ProjectImpl#getFramework
 * <em>Framework</em>}</li>
 * </ul>
 *
 * @generated
...
public class ProjectImpl extends MinimalEObjectImpl.Container implements Project {
	...
	protected EClass eStaticClass() {
		return ForgePackage.Literals.PROJECT;
	}
	...
	public void setGroupId(String newGroupId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ForgePackage.PROJECT__GROUP_ID,
					oldGroupId, groupId));
	}
	...
	public void setJavaVersion(int newJavaVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ForgePackage.PROJECT__JAVA_VERSION,
	...
	public void setSpringBootVersion(String newSpringBootVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ForgePackage.PROJECT__SPRING_BOOT_VERSION, oldSpringBootVersion,
					springBootVersion));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ForgePackage.PROJECT__NAME, oldName,
					name));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ForgePackage.PROJECT__VERSION,
					oldVersion, version));
	}
	...
	public void setLanguage(Language newLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ForgePackage.PROJECT__LANGUAGE,
	...
	public void setFramework(Framework newFramework) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ForgePackage.PROJECT__FRAMEWORK,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ForgePackage.PROJECT__GROUP_ID:
				return getGroupId();
			case ForgePackage.PROJECT__JAVA_VERSION:
				return getJavaVersion();
			case ForgePackage.PROJECT__SPRING_BOOT_VERSION:
				return getSpringBootVersion();
			case ForgePackage.PROJECT__NAME:
				return getName();
			case ForgePackage.PROJECT__VERSION:
				return getVersion();
			case ForgePackage.PROJECT__LANGUAGE:
				return getLanguage();
			case ForgePackage.PROJECT__FRAMEWORK:
				return getFramework();
		}
