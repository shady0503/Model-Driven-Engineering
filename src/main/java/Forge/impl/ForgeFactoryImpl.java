...
public class ForgeFactoryImpl extends EFactoryImpl implements ForgeFactory {
	...
	public static ForgeFactory init() {
		try {
			ForgeFactory theForgeFactory = (ForgeFactory)EPackage.Registry.INSTANCE.getEFactory(ForgePackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ForgePackage.BACKEND_CONFIG: return createBackendConfig();
			case ForgePackage.PROJECT: return createProject();
			case ForgePackage.DATABASE: return createDatabase();
			case ForgePackage.TABLE: return createTable();
			case ForgePackage.COLUMN: return createColumn();
			case ForgePackage.RELATION: return createRelation();
			case ForgePackage.API: return createApi();
			case ForgePackage.ROUTE: return createRoute();
			default:
