...
import Forge.DatabaseType;
import Forge.FetchType;
import Forge.Framework;
import Forge.HttpMethod;
import Forge.JpaCascadeType;
import Forge.Language;
import Forge.ForgeFactory;
...
public class ForgePackageImpl extends EPackageImpl implements ForgePackage {
	 ...
	 * @see Forge.ForgePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * {@link ForgePackage#eINSTANCE} when that field is accessed.
	...
	public static ForgePackage init() {
		if (isInited)
			return (ForgePackage) EPackage.Registry.INSTANCE
					.getEPackage(ForgePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredForgePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		ForgePackageImpl theForgePackage = registeredForgePackage instanceof ForgePackageImpl
				? (ForgePackageImpl) registeredForgePackage
	...
	public void createPackageContents() {
		...
		createEReference(tableEClass, TABLE__RELATIONS);
