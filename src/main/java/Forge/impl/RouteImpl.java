 ...
 * </p>
 * <ul>
 *   <li>{@link Forge.impl.RouteImpl#getEntity <em>Entity</em>}</li>
 *   <li>{@link Forge.impl.RouteImpl#getMethods <em>Methods</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RouteImpl extends MinimalEObjectImpl.Container implements Route {
	...
	protected EClass eStaticClass() {
		return ForgePackage.Literals.ROUTE;
	}
	...
	public void setEntity(String newEntity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ForgePackage.ROUTE__ENTITY, oldEntity, entity));
	}
	...
	public EList<HttpMethod> getMethods() {
		if (methods == null) {
			methods = new EDataTypeUniqueEList<HttpMethod>(HttpMethod.class, this, ForgePackage.ROUTE__METHODS);
		}
		return methods;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ForgePackage.ROUTE__ENTITY:
				return getEntity();
			case ForgePackage.ROUTE__METHODS:
				return getMethods();
		}
