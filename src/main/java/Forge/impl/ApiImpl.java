 ...
 * </p>
 * <ul>
 *   <li>{@link Forge.impl.ApiImpl#getBasePath <em>Base Path</em>}</li>
 *   <li>{@link Forge.impl.ApiImpl#getRoutes <em>Routes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ApiImpl extends MinimalEObjectImpl.Container implements Api {
	...
	protected EClass eStaticClass() {
		return ForgePackage.Literals.API;
	}
	...
	public void setBasePath(String newBasePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ForgePackage.API__BASE_PATH, oldBasePath, basePath));
	}
	...
	public EList<Route> getRoutes() {
		if (routes == null) {
			routes = new EObjectContainmentEList<Route>(Route.class, this, ForgePackage.API__ROUTES);
		}
		return routes;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ForgePackage.API__BASE_PATH:
				return getBasePath();
			case ForgePackage.API__ROUTES:
				return getRoutes();
		}
