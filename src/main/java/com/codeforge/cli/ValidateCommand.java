...
import com.codeforge.loader.LoadException;
 ...
 */
@Command(name = "validate", aliases = { "val",
        "v" }, description = "Validate a YAML model file without generating code", mixinStandardHelpOptions = true, headerHeading = "%n", synopsisHeading = "%nUsage: ", descriptionHeading = "%nDescription:%n", parameterListHeading = "%nParameters:%n", optionListHeading = "%nOptions:%n", footerHeading = "%n", footer = {
                "Examples:",
                "  Forge-gen validate examples/healthcare-system.yaml",
                "  Forge-gen validate examples/blog.yaml --strict",
                "  Forge-gen validate examples/trading.yaml --format json"
        })
public class ValidateCommand implements Callable<Integer> {
    ...
    @Parameters(index = "0", description = "Path to the YAML model file", paramLabel = "<yaml-file>")
    private File yamlFile;

    @Option(names = { "-f",
            "--format" }, description = "Output format: text, json (default: text)", paramLabel = "<format>")
    ...
    public Integer call() throws Exception {
        ...
        try {
            ...
            FlexmiModelLoaderWithValidation loader = createLoader();
    ...
    protected FlexmiModelLoaderWithValidation createLoader() {
        return new FlexmiModelLoaderWithValidation();
    }
}
