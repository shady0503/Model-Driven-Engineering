...
import com.mde.ModelDrivenEngineering.DatabaseType;
import com.mde.ModelDrivenEngineering.Framework;
import com.mde.ModelDrivenEngineering.HttpMethod;
import com.mde.ModelDrivenEngineering.Language;
import com.mde.ModelDrivenEngineering.ModelDrivenFactory;
 ...
 * @generated
 */
public class ModelDrivenPackageImpl extends EPackageImpl implements ModelDrivenPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see com.mde.ModelDrivenEngineering.ModelDrivenPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ModelDrivenPackageImpl() {
		super(eNS_URI, ModelDrivenFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link ModelDrivenPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ModelDrivenPackage init() {
		if (isInited) return (ModelDrivenPackage)EPackage.Registry.INSTANCE.getEPackage(ModelDrivenPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredModelDrivenPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		ModelDrivenPackageImpl theModelDrivenPackage = registeredModelDrivenPackage instanceof ModelDrivenPackageImpl ? (ModelDrivenPackageImpl)registeredModelDrivenPackage : new ModelDrivenPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theModelDrivenPackage.createPackageContents();

		// Initialize created meta-data
		theModelDrivenPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theModelDrivenPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ModelDrivenPackage.eNS_URI, theModelDrivenPackage);
		return theModelDrivenPackage;
	}
	 ...
	 */
	@Override
	public EClass getBackendConfig() {
		return backendConfigEClass;
	}
	 ...
	 */
	@Override
	public EEnum getFramework() {
		return frameworkEEnum;
	}
	 ...
	 */
	@Override
	public ModelDrivenFactory getModelDrivenFactory() {
		return (ModelDrivenFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		backendConfigEClass = createEClass(BACKEND_CONFIG);
		createEReference(backendConfigEClass, BACKEND_CONFIG__PROJECT);
		createEReference(backendConfigEClass, BACKEND_CONFIG__DATABASE);
		createEReference(backendConfigEClass, BACKEND_CONFIG__API);
		...
		createEReference(columnEClass, COLUMN__RELATION);

		relationEClass = createEClass(RELATION);
		createEAttribute(relationEClass, RELATION__TARGET_TABLE);
		...
		createEReference(apiEClass, API__ROUTES);

		routeEClass = createEClass(ROUTE);
		createEAttribute(routeEClass, ROUTE__ENTITY);
		createEAttribute(routeEClass, ROUTE__METHODS);

		// Create enums
		languageEEnum = createEEnum(LANGUAGE);
		frameworkEEnum = createEEnum(FRAMEWORK);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getRelation_TargetColumn(), ecorePackage.getEString(), "targetColumn", null, 1, 1, Relation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRelation_OnDelete(), this.getCascadeType(), "onDelete", "RESTRICT", 1, 1, Relation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getApi_Routes(), this.getRoute(), null, "routes", null, 0, -1, Api.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEEnum(frameworkEEnum, Framework.class, "Framework");
		addEEnumLiteral(frameworkEEnum, Framework.SPRING_BOOT);
		...
		addEEnumLiteral(cascadeTypeEEnum, CascadeType.CASCADE);
		addEEnumLiteral(cascadeTypeEEnum, CascadeType.SET_NULL);
		addEEnumLiteral(cascadeTypeEEnum, CascadeType.RESTRICT);

		initEEnum(httpMethodEEnum, HttpMethod.class, "HttpMethod");
		addEEnumLiteral(httpMethodEEnum, HttpMethod.CREATE);
		addEEnumLiteral(httpMethodEEnum, HttpMethod.READ);
		addEEnumLiteral(httpMethodEEnum, HttpMethod.UPDATE);
