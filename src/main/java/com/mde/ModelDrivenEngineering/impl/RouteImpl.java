 ...
 * </p>
 * <ul>
 *   <li>{@link com.mde.ModelDrivenEngineering.impl.RouteImpl#getEntity <em>Entity</em>}</li>
 *   <li>{@link com.mde.ModelDrivenEngineering.impl.RouteImpl#getMethods <em>Methods</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RouteImpl extends MinimalEObjectImpl.Container implements Route {
	...
	protected EClass eStaticClass() {
		return ModelDrivenPackage.Literals.ROUTE;
	}
	...
	public void setEntity(String newEntity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelDrivenPackage.ROUTE__ENTITY, oldEntity, entity));
	}
	...
	public EList<HttpMethod> getMethods() {
		if (methods == null) {
			methods = new EDataTypeUniqueEList<HttpMethod>(HttpMethod.class, this, ModelDrivenPackage.ROUTE__METHODS);
		}
		return methods;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelDrivenPackage.ROUTE__ENTITY:
				return getEntity();
			case ModelDrivenPackage.ROUTE__METHODS:
				return getMethods();
		}
