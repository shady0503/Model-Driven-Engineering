 ...
 * </p>
 * <ul>
 *   <li>{@link Context.impl.RelationContextImpl#getFieldName <em>Field Name</em>}</li>
 *   <li>{@link Context.impl.RelationContextImpl#getTargetEntity <em>Target Entity</em>}</li>
 *   <li>{@link Context.impl.RelationContextImpl#getRelationType <em>Relation Type</em>}</li>
 *   <li>{@link Context.impl.RelationContextImpl#isIsOwner <em>Is Owner</em>}</li>
 *   <li>{@link Context.impl.RelationContextImpl#getJoinColumnName <em>Join Column Name</em>}</li>
 *   <li>{@link Context.impl.RelationContextImpl#getJoinTableName <em>Join Table Name</em>}</li>
 *   <li>{@link Context.impl.RelationContextImpl#getInverseJoinColumnName <em>Inverse Join Column Name</em>}</li>
 *   <li>{@link Context.impl.RelationContextImpl#getMappedBy <em>Mapped By</em>}</li>
 *   <li>{@link Context.impl.RelationContextImpl#getCascadeType <em>Cascade Type</em>}</li>
 *   <li>{@link Context.impl.RelationContextImpl#getFetchType <em>Fetch Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelationContextImpl extends MinimalEObjectImpl.Container implements RelationContext {
	...
	/**
	 * The default value of the '{@link #getInverseJoinColumnName() <em>Inverse Join Column Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getInverseJoinColumnName() <em>Inverse Join Column Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getInverseJoinColumnName()
	 * @generated
	...
	public void setJoinTableName(String newJoinTableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ContextPackage.RELATION_CONTEXT__JOIN_TABLE_NAME, oldJoinTableName, joinTableName));
	}
	...
	public void setInverseJoinColumnName(String newInverseJoinColumnName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ContextPackage.RELATION_CONTEXT__INVERSE_JOIN_COLUMN_NAME, oldInverseJoinColumnName, inverseJoinColumnName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ContextPackage.RELATION_CONTEXT__JOIN_TABLE_NAME:
				return getJoinTableName();
			case ContextPackage.RELATION_CONTEXT__INVERSE_JOIN_COLUMN_NAME:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case ContextPackage.RELATION_CONTEXT__INVERSE_JOIN_COLUMN_NAME:
				return INVERSE_JOIN_COLUMN_NAME_EDEFAULT == null ? inverseJoinColumnName != null : !INVERSE_JOIN_COLUMN_NAME_EDEFAULT.equals(inverseJoinColumnName);
			case ContextPackage.RELATION_CONTEXT__MAPPED_BY:
