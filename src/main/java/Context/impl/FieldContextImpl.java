 ...
 * </p>
 * <ul>
 *   <li>{@link Context.impl.FieldContextImpl#getColumnName <em>Column Name</em>}</li>
 *   <li>{@link Context.impl.FieldContextImpl#getFieldName <em>Field Name</em>}</li>
 *   <li>{@link Context.impl.FieldContextImpl#getJavaType <em>Java Type</em>}</li>
 *   <li>{@link Context.impl.FieldContextImpl#isIsPrimaryKey <em>Is Primary Key</em>}</li>
 *   <li>{@link Context.impl.FieldContextImpl#isIsNullable <em>Is Nullable</em>}</li>
 *   <li>{@link Context.impl.FieldContextImpl#isIsUnique <em>Is Unique</em>}</li>
 *   <li>{@link Context.impl.FieldContextImpl#isIsAuditField <em>Is Audit Field</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FieldContextImpl extends MinimalEObjectImpl.Container implements FieldContext {
	...
	/**
	 * The default value of the '{@link #isIsAuditField() <em>Is Audit Field</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isIsAuditField()
	 * @generated
	 * @ordered
	 */
	protected static final boolean IS_AUDIT_FIELD_EDEFAULT = false;

	/**
	 * The cached value of the '{@link #isIsAuditField() <em>Is Audit Field</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isIsAuditField()
	 * @generated
	 * @ordered
	 */
	protected boolean isAuditField = IS_AUDIT_FIELD_EDEFAULT;
	 ...
	 */
	@Override
	public void setIsAuditField(boolean newIsAuditField) {
		boolean oldIsAuditField = isAuditField;
		isAuditField = newIsAuditField;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ContextPackage.FIELD_CONTEXT__IS_AUDIT_FIELD, oldIsAuditField, isAuditField));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ContextPackage.FIELD_CONTEXT__IS_UNIQUE:
				return isIsUnique();
			case ContextPackage.FIELD_CONTEXT__IS_AUDIT_FIELD:
				return isIsAuditField();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ContextPackage.FIELD_CONTEXT__IS_UNIQUE:
				...
				return;
			case ContextPackage.FIELD_CONTEXT__IS_AUDIT_FIELD:
				setIsAuditField((Boolean)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ContextPackage.FIELD_CONTEXT__IS_UNIQUE:
				...
				return;
			case ContextPackage.FIELD_CONTEXT__IS_AUDIT_FIELD:
				setIsAuditField(IS_AUDIT_FIELD_EDEFAULT);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case ContextPackage.FIELD_CONTEXT__IS_AUDIT_FIELD:
				return isAuditField != IS_AUDIT_FIELD_EDEFAULT;
		}
