...
public class ContextPackageImpl extends EPackageImpl implements ContextPackage {
	 ...
	 */
	@Override
	public EAttribute getFieldContext_IsAuditField() {
		return (EAttribute)fieldContextEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 */
	@Override
	public EAttribute getRelationContext_JoinTableName() {
	 ...
	 */
	@Override
	public EAttribute getRelationContext_InverseJoinColumnName() {
	...
	public EAttribute getRelationContext_CascadeType() {
		return (EAttribute)relationContextEClass.getEStructuralFeatures().get(8);
	}
	...
	public EAttribute getRelationContext_FetchType() {
		return (EAttribute)relationContextEClass.getEStructuralFeatures().get(9);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(fieldContextEClass, FIELD_CONTEXT__IS_AUDIT_FIELD);
		...
		createEAttribute(relationContextEClass, RELATION_CONTEXT__JOIN_TABLE_NAME);
		createEAttribute(relationContextEClass, RELATION_CONTEXT__INVERSE_JOIN_COLUMN_NAME);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getFieldContext_IsAuditField(), ecorePackage.getEBoolean(), "isAuditField", "false", 1, 1, FieldContext.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRelationContext_JoinTableName(), ecorePackage.getEString(), "joinTableName", null, 0, 1, RelationContext.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRelationContext_InverseJoinColumnName(), ecorePackage.getEString(), "inverseJoinColumnName", null, 0, 1, RelationContext.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
