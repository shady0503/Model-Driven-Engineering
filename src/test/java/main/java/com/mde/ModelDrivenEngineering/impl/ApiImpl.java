 ...
 * </p>
 * <ul>
 *   <li>{@link com.mde.ModelDrivenEngineering.impl.ApiImpl#getBasePath <em>Base Path</em>}</li>
 *   <li>{@link com.mde.ModelDrivenEngineering.impl.ApiImpl#getRoutes <em>Routes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ApiImpl extends MinimalEObjectImpl.Container implements Api {
	...
	protected EClass eStaticClass() {
		return ModelDrivenPackage.Literals.API;
	}
	...
	public void setBasePath(String newBasePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelDrivenPackage.API__BASE_PATH, oldBasePath, basePath));
	}
	...
	public EList<Route> getRoutes() {
		if (routes == null) {
			routes = new EObjectContainmentEList<Route>(Route.class, this, ModelDrivenPackage.API__ROUTES);
		}
		return routes;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelDrivenPackage.API__ROUTES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelDrivenPackage.API__BASE_PATH:
				return getBasePath();
			case ModelDrivenPackage.API__ROUTES:
				return getRoutes();
		}
